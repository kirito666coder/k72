...
function AgencyThumbnailCards() {
  return (
    <>
    <div className=" bg-black group transition-all duration-100 cursor-pointer mt-40 md:mt-90 h-[900px] w-full sticky top-0 rounded-4xl overflow-hidden">
      ...
      <LazyLoadImage src="./images/chalaxeur-thumbnail_img.jpg" className="  transition-all duration-600 group-hover:scale-105 h-full w-full object-cover " alt="" />
    </div>
    <div className=" bg-black group transition-all duration-100 cursor-pointer mt-40 md:mt-90 h-[900px] w-full sticky top-0 rounded-4xl overflow-hidden">
       <div className="z-20 h-full w-full absolute top-0 left-0 flex flex-col justify-center items-center font-[font2]">
       ...
       <div className="absolute top-0 left-0 h-full w-full group-hover:bg-black/20 z-10"></div>
      <LazyLoadImage src="./images/crisis24_behance.jpg" className="  transition-all duration-600 group-hover:scale-105 h-full w-full object-cover " alt="" />
    </div>
    <div className=" bg-black group transition-all duration-100 cursor-pointer  mt-40 md:mt-90 h-[900px] w-full sticky top-0 rounded-4xl overflow-hidden">
       <div className="z-20 h-full w-full absolute top-0 left-0 flex flex-col justify-center items-center font-[font2]">
       ...
       <div className="absolute top-0 left-0 h-full w-full group-hover:bg-black/20 z-10"></div>
      <LazyLoadImage src="./images/Fruite_thumbnail_bbq.jpg" className="  transition-all duration-600 group-hover:scale-105 h-full w-full object-cover " alt="" />
    </div>
